...
const DESC = "Precision CAD modelling and product development for industrial products, plastic components, tooling systems and production-ready manufacturing designs.";
...
export const Route = createFileRoute("/cad-modelling-services")({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "CAD modelling services, product development India, 3D CAD design Hyderabad, SolidWorks design services, plastic part design, DFM engineering" },
    ],
    links: [{ rel: "canonical", href: "/cad-modelling-services" }],
  }),
  component: () => (
    <ServicePage
      eyebrow="CAD Modelling & Product Development"
      title={<>Precision <span className="text-gradient-blue">CAD Modelling</span> &amp; Product Engineering.</>}
      ...
      faqs={[
        { q: "Which CAD software do you work in?", a: "Primarily SolidWorks, Creo, NX and Fusion 360. We can also deliver in client-specified CAD formats." },
        { q: "Do you handle full product development?", a: "Yes — from concept and CAD through prototyping, tooling and mass production under one engineering roof." },
        { q: "Can you sign NDAs?", a: "Absolutely. All product development engagements are run under strict NDA and IP protection." },
      ]}
      related={[
