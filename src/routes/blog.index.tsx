...
const DESC =
  "Practical insights on 3D scanning, reverse engineering, precision manufacturing, mould design and industrial product development from Yetki Engineering.";

export const Route = createFileRoute("/blog/")({
  head: () => ({
    meta: [
      ...seoMeta({ title: TITLE, description: DESC, path: "/blog", image: ARTICLES[0]?.cover }),
      {
        name: "keywords",
        content:
          "engineering blog India, 3D scanning blog, reverse engineering articles, manufacturing insights, mould design articles",
      },
    ],
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
      ...
      <p className="mt-5 max-w-2xl text-base text-foreground/70 leading-relaxed">
        Field-tested writing on 3D scanning, reverse engineering, mould making, and the industrial
        product pipeline — from the Yetki Engineering team in Hyderabad.
      </p>
      ...
      >
        ...
        <div className="p-8 lg:p-10 flex flex-col justify-center">
          <div className="text-[10px] uppercase tracking-[0.22em] text-blue-300">
