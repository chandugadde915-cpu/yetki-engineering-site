...
const TITLE = "3D Scanning Services in India | Industrial Blue Light & Laser 3D Scanning | Yetki Engineering";
const DESC = "High-accuracy 3D scanning services in Hyderabad, India. Industrial blue light and laser 3D scanning for automotive, aerospace, tooling and manufacturing. Sub-0.01mm precision.";
...
export const Route = createFileRoute("/3d-scanning-services")({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "3D scanning services India, industrial 3D scanning Hyderabad, blue light 3D scanner, laser 3D scanning, metrology scanning, reverse engineering scanning" },
      { property: "og:title", content: TITLE },
      { property: "og:description", content: DESC },
    ],
    links: [{ rel: "canonical", href: "/3d-scanning-services" }],
  }),
  component: () => (
    <ServicePage
      eyebrow="3D Scanning Services"
      title={<>Industrial <span className="text-gradient-blue">3D Scanning</span> with Metrology-Grade Precision.</>}
      ...
      faqs={[
        { q: "What accuracy can your 3D scanning achieve?", a: "Our industrial scanners deliver sub-0.01 mm accuracy depending on part geometry, scanner selection and environmental conditions." },
        { q: "Do you offer on-site 3D scanning across India?", a: "Yes. We provide on-site 3D scanning across India, including Hyderabad, Bengaluru, Chennai, Pune, Mumbai, Delhi and industrial clusters nationwide." },
        { q: "What file formats do you deliver?", a: "We deliver STL, OBJ, PLY, STEP, IGES, X_T and native CAD formats, along with PDF inspection reports." },
        { q: "Can you scan very large or very small parts?", a: "Yes — our fleet covers micro components down to a few millimetres and large assemblies several metres in scale." },
        { q: "How quickly can scans be delivered?", a: "Typical turnaround is 24–72 hours depending on complexity, deliverable and on-site logistics." },
      ]}
      related={[
