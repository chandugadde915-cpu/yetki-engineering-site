...
import {
  ScanLine, Cog, Layers3, Boxes, Factory, Wrench, ShoppingBag,
  Car, HeartPulse, Cpu, Plane, Hammer, Package, Building2,
  ShieldCheck, Zap, Gauge, Users, CheckCircle2, ArrowRight, Mail, Phone, MapPin,
} from "lucide-react";
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid lg:grid-cols-12 gap-12">
        <div className="lg:col-span-5">
          <SectionTitle
            ...
            title={<>Trusted partner in <span className="text-gradient-blue">industrial precision</span> and reverse engineering.</>}
          />
          <p className="mt-6 text-foreground/70 leading-relaxed">
            Yetki Engineering Pvt Ltd is an industrial engineering company delivering high-precision manufacturing and reverse engineering solutions for automotive, industrial machinery, consumer, and medical sectors. We bridge advanced metrology, CAD reconstruction, and scalable production under one engineering roof.
          </p>
        ...
        <div className="lg:col-span-7">
          <div className="relative aspect-[4/3] rounded-3xl overflow-hidden glass-strong glow-blue">
            <img src={components} alt="Precision machined industrial components" width={1280} height={960} loading="lazy" className="h-full w-full object-cover" />
          ...
          <div className="mt-6 grid grid-cols-2 sm:grid-cols-4 gap-3">
            {stats.map((s, i) => (
              ...
              >
                ...
                <div className="text-[11px] uppercase tracking-[0.16em] text-muted-foreground mt-1.5">{s.label}</div>
              </motion.div>
            ))}
          </div>
        </div>
...
// ---------------- Services ----------------
const SERVICES = [
  { icon: ScanLine, title: "3D Scanning", to: "/3d-scanning-services",
  ...
  { icon: Cog, title: "Reverse Engineering", to: "/reverse-engineering-services",
  ...
  { icon: Layers3, title: "CAD Modelling & Product Development", to: "/cad-modelling-services",
  ...
  { icon: Hammer, title: "Mould Design & Mould Making", to: "/mould-design-manufacturing",
  ...
  { icon: Factory, title: "Mass Production", to: "/precision-manufacturing",
  ...
  { icon: Boxes, title: "Industrial Component Manufacturing", to: "/precision-manufacturing",
    desc: "Custom industrial component manufacturing for heavy machinery, engineering systems, and production equipment." },
  { icon: ShoppingBag, title: "3D Scanner Sales & Support", to: "/3d-scanner-sales",
  ...
  return (
    <section id="services" className="relative py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          kicker="Capabilities"
          title={<>Engineering services that <span className="text-gradient-blue">scale precision</span> from prototype to production.</>}
          ...
          {SERVICES.map((s, i) => (
            ...
            >
              ...
              <div className="relative">
                ...
                <Link to={s.to} className="mt-5 inline-flex items-center gap-1 text-xs font-semibold text-blue-300 hover:text-blue-200">
    ...
    <section id="industries" className="relative py-24 overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          ...
          title={<>Engineering across <span className="text-gradient-blue">mission-critical</span> sectors.</>}
        />
...
export function Showcase() {
  const items = [
    { img: components, t: "Precision Machined Parts", d: "Sub-micron tolerances for critical assemblies." },
    { img: mould, t: "Injection Moulds", d: "Hardened steel moulds for high-volume production." },
    { img: cad, t: "Reverse Engineered CAD", d: "Legacy components rebuilt as production-ready models." },
    { img: scanner, t: "3D Scanner Systems", d: "Blue-light and laser scanners with metrology accuracy." },
  ];
  return (
    <section className="relative py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          ...
          title={<>What we <span className="text-gradient-blue">design, scan, and manufacture</span>.</>}
        />
          ...
          {items.map((p, i) => (
            ...
            >
              <div className="aspect-[4/5] overflow-hidden">
                <img src={p.img} alt={p.t} loading="lazy" className="h-full w-full object-cover group-hover:scale-110 transition-transform duration-[1200ms]" />
              </div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid lg:grid-cols-12 gap-10 items-center">
        <div className="lg:col-span-5">
          <SectionTitle
            ...
            title={<>Metrology-grade <span className="text-gradient-blue">3D scanning systems</span> for industrial precision.</>}
          ...
          <div className="mt-8 grid grid-cols-2 gap-3">
            {stats.map((s) => (
              <div key={s.l} className="glass rounded-2xl p-5">
                <div className="text-3xl font-semibold text-gradient">{s.v}<span className="text-base text-blue-300 ml-1">{s.u}</span></div>
                <div className="text-[11px] uppercase tracking-[0.16em] text-muted-foreground mt-1">{s.l}</div>
              </div>
            ))}
          </div>
        </div>
        <div className="lg:col-span-7">
          <div className="relative aspect-[4/3] rounded-3xl overflow-hidden glass-strong glow-blue">
            <img src={scanner} alt="3D industrial scanner" loading="lazy" className="h-full w-full object-cover" />
            ...
            <div className="absolute inset-x-6 bottom-6 grid sm:grid-cols-3 gap-3">
              {scanners.map((s) => (
                <div key={s.name} className="glass-strong rounded-xl p-3">
                  <div className="text-[10px] uppercase tracking-[0.18em] text-blue-300">{s.tag}</div>
...
export function WhyChooseUs() {
  const items = [
    { i: ShieldCheck, t: "Industrial-Grade Quality", d: "Every component is verified against tolerance and material specs." },
    { i: Gauge, t: "High Precision Engineering", d: "Sub-micron accuracy backed by metrology-grade scanning." },
    { i: Zap, t: "Fast Turnaround", d: "Streamlined pipeline from scan to delivered part." },
    { i: Factory, t: "Scalable Production", d: "From prototype to mass production with consistent quality." },
    { i: Cpu, t: "Advanced Scanner Technology", d: "Latest blue-light, laser & infrared systems in-house." },
    { i: Users, t: "Expert Engineering Team", d: "Mechanical, manufacturing and CAD specialists under one roof." },
  ];
  return (
    <section className="relative py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          kicker="Why Yetki"
          title={<>An engineering partner <span className="text-gradient-blue">built for industry</span>.</>}
        />
        <div className="mt-14 grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {items.map((it, i) => (
            <motion.div
  ...
  return (
    <section id="case-studies" className="relative py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          kicker="Case studies"
          title={<>Engineering outcomes, <span className="text-gradient-blue">measured</span>.</>}
        />
          ...
          {cases.map((c, i) => (
            ...
            >
              <div className="aspect-[16/10] overflow-hidden relative">
                <img src={c.img} alt={c.title} loading="lazy" className="h-full w-full object-cover group-hover:scale-105 transition-transform duration-700" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
                <span className="absolute top-3 left-3 text-[10px] uppercase tracking-[0.2em] glass px-2 py-1 rounded">{c.tag}</span>
              </div>
              <div className="p-6">
                ...
                <div className="mt-4 flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-[10px] uppercase tracking-[0.16em] text-muted-foreground">{c.stat[1]}</div>
                  </div>
...
export function FAQ() {
  const faqs = [
    { q: "What 3D scanning services does Yetki Engineering provide?", a: "We provide industrial blue-light, laser and infrared 3D scanning for automotive, aerospace, tooling, medical and consumer sectors — with sub-0.01mm accuracy and metrology-grade reporting." },
    { q: "Do you offer reverse engineering for legacy components?", a: "Yes. We reverse engineer legacy and obsolete parts into production-ready CAD models for redesign, replication and manufacturing optimization." },
    { q: "Can you manufacture injection moulds?", a: "We design and manufacture injection moulds for plastic and metal components with industrial-grade dimensional tolerances and validated tool life." },
    { q: "Where are you located?", a: "Yetki Engineering Pvt Ltd is headquartered in Hyderabad, Telangana, India and serves clients across India and globally." },
    { q: "Do you sell industrial 3D scanners?", a: "Yes — we are a supplier and service partner for professional 3D scanners including blue-light, laser, metrology, and jewellery-grade scanning systems." },
  ];
  const [open, setOpen] = useState(0);
  return (
    <section id="faq" className="relative py-24">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <SectionTitle kicker="Frequently asked" title={<>Answers about our <span className="text-gradient-blue">engineering services</span>.</>} />
        <div className="mt-12 space-y-3">
          {faqs.map((f, i) => (
            <div key={i} className="rounded-2xl glass overflow-hidden">
              <button onClick={() => setOpen(open === i ? -1 : i)} className="w-full flex items-center justify-between text-left p-5">
                <span className="text-sm sm:text-base font-medium">{f.q}</span>
                <span className={`text-blue-300 transition-transform ${open === i ? "rotate-45" : ""}`}>+</span>
              </button>
...
export function Contact() {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setSubmitMessage(error instanceof Error ? error.message : "We could not send your request right now. Please call or email us directly.");
    }
  }
    ...
    <section id="contact" className="relative py-24 overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-10 items-start">
        <div>
          <SectionTitle
            kicker="Contact"
            title={<>Engineer your next <span className="text-gradient-blue">precision project</span> with us.</>}
          ...
          <div className="mt-8 space-y-4">
            <div className="flex items-center gap-3 glass rounded-xl p-4">
              ...
              <div>
                ...
                <a href="tel:+919505923789" className="text-sm font-medium">+91-9505923789</a>
              </div>
            </div>
            <div className="flex items-center gap-3 glass rounded-xl p-4">
              ...
              <div>
                ...
                <a href="mailto:info@yetkiengineering.com" className="text-sm font-medium">info@yetkiengineering.com</a>
              </div>
            </div>
        ...
        <form
          ...
          className="rounded-3xl glass-strong p-6 sm:p-8 glow-blue"
        >
          ...
          <div className="mt-4">
            <label className="text-[11px] uppercase tracking-[0.18em] text-muted-foreground">Service</label>
            <select name="service" className="mt-1.5 w-full rounded-xl bg-white/5 border border-white/10 px-4 py-3 text-sm focus:border-blue-400/60 outline-none">
          ...
          <div className="mt-4">
            <label className="text-[11px] uppercase tracking-[0.18em] text-muted-foreground">Project details</label>
            <textarea name="projectDetails" rows={5} className="mt-1.5 w-full rounded-xl bg-white/5 border border-white/10 px-4 py-3 text-sm focus:border-blue-400/60 outline-none resize-none" placeholder="Describe your component, tolerances, volume, or scanning needs." />
          </div>
          <button
            type="submit"
...
export function LogoStrip() {
  const items = ["Automotive", "Aerospace", "Medical", "Tooling", "Consumer", "Industrial", "Plastics", "Robotics"];
  return (
    <div className="relative border-y border-white/5 py-6 overflow-hidden">
      <div className="flex gap-12 whitespace-nowrap animate-[spin-slow_60s_linear_infinite]" style={{ animation: "none" }}>
        <div className="flex gap-12 animate-marquee">
          {[...items, ...items].map((it, i) => (
            <span key={i} className="text-xs uppercase tracking-[0.3em] text-muted-foreground">{it} •</span>
          ))}
        </div>
      </div>
      <style>{`
