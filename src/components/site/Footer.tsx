      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 grid gap-10 md:grid-cols-4">
        <div className="md:col-span-2">
          ...
          <p className="mt-5 max-w-md text-sm text-muted-foreground leading-relaxed">
            ...
            reconstruction, mould design, and scalable production for industrial innovation.
          </p>
          <div className="mt-6 space-y-3 text-sm text-foreground/80">
            <div className="flex items-center gap-2">
              <Phone size={14} className="text-blue-400" />
              <span>+91-9505923789</span>
            </div>
            <div className="flex items-center gap-2">
              <Mail size={14} className="text-blue-400" />
              <span>info@yetkiengineering.com</span>
            </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <Link to="/3d-scanning-services" className="hover:text-blue-300">
                3D Scanning Services
              </Link>
            </li>
            <li>
              <Link to="/reverse-engineering-services" className="hover:text-blue-300">
                Reverse Engineering
              </Link>
            </li>
            <li>
              <Link to="/cad-modelling-services" className="hover:text-blue-300">
                CAD Modelling
              </Link>
            </li>
            <li>
              <Link to="/mould-design-manufacturing" className="hover:text-blue-300">
                Mould Design & Making
              </Link>
            </li>
            <li>
              <Link to="/precision-manufacturing" className="hover:text-blue-300">
                Precision Manufacturing
              </Link>
            </li>
            <li>
              <Link to="/3d-scanner-sales" className="hover:text-blue-300">
                3D Scanner Sales
              </Link>
            </li>
            <li>
              <Link to="/industrial-product-development" className="hover:text-blue-300">
                Product Development
              </Link>
            </li>
            <li>
              <Link to="/3d-scanning-services-hyderabad" className="hover:text-blue-300">
                3D Scanning Hyderabad
              </Link>
            </li>
            <li>
              <Link to="/reverse-engineering-company-india" className="hover:text-blue-300">
                Reverse Engineering India
              </Link>
            </li>
            <li>
              <Link to="/precision-engineering-company-india" className="hover:text-blue-300">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <a href="/#industries" className="hover:text-blue-300">
                Industries
              </a>
            </li>
            <li>
              <Link to="/case-studies" className="hover:text-blue-300">
                Case Studies
              </Link>
            </li>
            <li>
